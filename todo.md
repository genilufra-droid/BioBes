...
- [ ] Shto regresione vizuale/kontraktuale për rrjedhën Raporte → Kryesore → modul → model → filtër → dokument dhe verifiko desktop/mobile para checkpoint-it.
...
- [ ] Sinkronizo në BioBes panelin Alpha të tab-it Raporti dhe accordion-in e Blerjeve të implementuar pas commit-it `e9aa110`; ekzekuto CI web/windows green para dorëzimit.
