...
- [ ] GitHub: audito source code-in aktual, historikun, skedarët e ndjeshëm dhe skedarët e gjeneruar para eksportit.
- [ ] GitHub: përgatit .env.example, LICENSE, CHANGELOG, CONTRIBUTING, docs dhe strukturën e zhvilluesit pa ekspozuar secrets ose të dhëna reale.
- [ ] GitHub: shto wrapper Windows dhe konfigurimin build:windows/CI që përdor të njëjtin frontend.
- [ ] GitHub: inicializo main/develop, commit-e logjike, tag v1.0.0 dhe ngarko repository-n private biobes.
- [ ] GitHub: verifiko repository-n, klonimin e pastër, numrin e skedarëve dhe kontrollet e sigurisë.
