...
type PurchaseReportInlineFiltersProps = {
  ...
  moduleLabel?: "Blerje" | "Shitje";
  partnerLabel?: "FURNITORI" | "KLIENTI";
...
export default function PurchaseReportInlineFilters({
  ...
  return <section data-purchase-inline-filters className="border border-[#858585] bg-[#efefef] text-[#202020] shadow-none">
    <header className="flex min-h-11 flex-wrap items-center justify-between gap-2 border-b border-[#b8b8b8] bg-[#efefef] px-3 py-1.5">
      <div className="flex min-w-0 items-center gap-2"><FileText className="h-4 w-4 text-[#0878c9]" /><h2 className="truncate text-sm font-semibold">Raporte {moduleLabel === "Shitje" ? "Shitjeje" : "Blerjeje"}</h2><span className="border border-[#b8b8b8] bg-white px-1.5 py-0.5 text-[10px]">{moduleLabel}</span></div>
