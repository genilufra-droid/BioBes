...
export default function AlphaReportInlineFilters({
  ...
  return <section data-alpha-inline-filters data-report-module={moduleLabel} className={`bg-[#f7f7f7] text-[#202020]${referenceResult ? " [&_[data-purchase-inline-result]]:hidden" : ""}`}>
    ...
    {hasExecuted && referenceResult && <div data-alpha-reference-result className="border-t-2 border-[#858585] bg-[#f7f7f7] p-3">{referenceResult}</div>}
