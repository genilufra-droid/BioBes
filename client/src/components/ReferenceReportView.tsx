...
export const REPORT_REFERENCE_TITLES: Record<string, string> = {
  ...
  purchase_invoices: "FATURAT E BLERJES",
  purchase_orders: "POROSITË E BLERJES",
  purchase_receipts: "PRANIMET E MALLIT",
  purchase_returns: "KTHIMET TE FURNITORËT",
  purchase_suppliers: "SHpenzimi SIPAS FURNITORIT",
  purchase_invoice_status: "STATUSI I FATURAVE",
  purchase_open_invoices: "FATURAT E HAPURA",
  purchase_invoice_volume: "VËLLIMI I FATURAVE",
  purchase_top_suppliers: "FURNITORËT KRYESORË",
  purchase_orders_open: "POROSITË E HAPURA",
  purchase_orders_status: "STATUSI I POROSIVE",
  purchase_receipts_by_supplier: "PRANIMET SIPAS FURNITORIT",
  purchase_receipts_timeline: "AFATI I PRANIMEVE",
  purchase_returns_analysis: "ANALIZA E KTHIMEVE",
  purchase_returns_status: "STATUSI I KTHIMEVE",
  purchase_spend_trend: "TRENDi I SHPENZIMEVE",
  purchase_supplier_count: "NUMRI I FURNITORËVE",
  purchase_document_register: "REGJISTRI I DOKUMENTEVE TË BLERJES",
  purchase_receipt_control: "KONTROLLI I PRANIMEVE",
...
export const REPORT_REFERENCE_GROUPS: Record<string, ReferenceHeaderGroup[]> = {
  ...
  purchase_invoices: [{ label: "Dokumenti", columns: ["Nr.", "Data", "Partneri", "Vlera", "Statusi"] }],
  purchase_orders: [{ label: "Dokumenti", columns: ["Nr.", "Data", "Partneri", "Vlera", "Statusi"] }],
  purchase_receipts: [{ label: "Dokumenti", columns: ["Nr.", "Data", "Partneri", "Statusi"] }],
  purchase_returns: [{ label: "Dokumenti", columns: ["Nr.", "Data", "Partneri", "Statusi"] }],
  purchase_invoice_status: [{ label: "Statusi", columns: ["Nr.", "Data", "Partneri", "Vlera", "Statusi"] }],
  purchase_open_invoices: [{ label: "Faturat", columns: ["Nr.", "Data", "Partneri", "Vlera", "Statusi"] }],
  purchase_orders_open: [{ label: "Porositë", columns: ["Nr.", "Data", "Partneri", "Vlera", "Statusi"] }],
  purchase_orders_status: [{ label: "Statusi", columns: ["Nr.", "Data", "Partneri", "Vlera", "Statusi"] }],
  purchase_document_register: [{ label: "Regjistrimi", columns: ["Nr.", "Data", "Partneri", "Vlera", "Statusi"] }],
  purchase_receipt_control: [{ label: "Kontrolli", columns: ["Nr.", "Data", "Partneri", "Statusi"] }],
