...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  if (!user) return <div className="grid min-h-screen place-items-center bg-[#e9edf0] p-5"><div className="w-full max-w-sm border border-[#9baab7] bg-white shadow-xl"><div className="flex items-center gap-3 border-b border-[#aebbc6] bg-[#d9e6ef] px-5 py-4"><GenitMark /><div><h1 className="text-sm font-bold text-[#244861]">Sistemi Genit Cloud</h1><p className="text-[11px] text-[#667684]">Alpha-style business workspace</p></div></div><div className="p-6"><h2 className="text-lg font-semibold text-[#2b3c49]">Mirë se vini</h2><p className="mt-2 text-sm leading-6 text-[#667684]">Hyni për të hapur kompaninë dhe ambientet e punës.</p><Button onClick={() => startLogin()} className="mt-5 h-9 w-full rounded-sm bg-[#2b6892] text-white hover:bg-[#205474]">Hyr në sistem</Button></div></div></div>;
