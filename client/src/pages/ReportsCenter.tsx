...
export default function ReportsCenter({ companyId }: { companyId: number }) {
  ...
  const viewReport = async () => {
    ...
    try {
      ...
      if (result.data) {
        ...
        if (isPurchaseModule || isSalesModule) {
          setIsReportOpen(true);
  ...
  const isSalesWorkspace = moduleFilter === "Shitje";
  const isAlphaDocumentWorkspace = isPurchaseWorkspace || isSalesWorkspace;
