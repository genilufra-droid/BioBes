...
export default function Registrations({ companyId }: { companyId: number }) {
  ...
  return <div data-alpha-registration-workspace><div className="alpha-admin-window mx-auto w-full max-w-[1180px] border border-[#8ea2b0] bg-[#edf2f5] shadow-[2px_3px_9px_rgba(37,62,80,0.28)]">
